...
class Recon_base(nn.Module):
    ...
    def init_encoder(self):
        ...
        self.image_encoder = UNet(
            in_ch=1,
            out_ch=cfg.out_ch,
            trunc_mode_stages=cfg.trunc_mode_stages,
            use_sobel_stages=cfg.use_sobel_stages,
            patch_based_stages=cfg.patch_based_stages,
            patch_size_stages=cfg.patch_size_stages,
            factorize_mode_stages=cfg.factorize_mode_stages,
            use_attn_stages=cfg.use_attn_stages,
            simple_propagate_stages=cfg.simple_propagate_stages,
            window_size_stages=cfg.window_size_stages,
            use_swin_stages=cfg.use_swin_stages,
            use_fno_only= cfg.use_fno_only,
            skip_type=cfg.skip_type,
            type_grid=cfg.type_grid,
            fuse_block=cfg.fuse_block
        )
