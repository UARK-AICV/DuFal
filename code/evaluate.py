...
if __name__ == '__main__':
    ...
    parser.add_argument('--setting', type=str, default='spatial')
    ...
    if args.name is None:
        args.name = f"DIFG-{args.setting}-{args.dst_name}_{args.num_views}v"
    ...
    ckpt = torch.load(ckpt_path, map_location=torch.device('cpu'), weights_only=False)  # Add weights_only=False
